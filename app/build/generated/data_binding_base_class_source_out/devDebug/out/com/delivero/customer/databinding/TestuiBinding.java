...
public final class TestuiBinding implements ViewBinding {
  ...
  private TestuiBinding(@NonNull RelativeLayout rootView, @NonNull CardView cardView,
  ...
  @NonNull
  public static TestuiBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static TestuiBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.testui, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TestuiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TestuiBinding((RelativeLayout) rootView, cardView, emailInput, emailLayout,
          layout1, logIn, nameInput, nameLayout, noAccount, passwordInput, passwordLayout,
