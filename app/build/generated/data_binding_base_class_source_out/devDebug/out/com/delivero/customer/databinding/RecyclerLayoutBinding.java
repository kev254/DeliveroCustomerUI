...
public final class RecyclerLayoutBinding implements ViewBinding {
  ...
  private RecyclerLayoutBinding(@NonNull RelativeLayout rootView, @NonNull MaterialTextView noData,
      @NonNull CircularProgressIndicator progress, @NonNull RecyclerView recycler) {
  ...
  public static RecyclerLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecyclerLayoutBinding((RelativeLayout) rootView, noData, progress, recycler);
    }
